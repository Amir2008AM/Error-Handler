...
export const metadata: Metadata = {
  alternates: { canonical: 'https://toolifypdf.online/compress-pdf' },
  ...
  openGraph: {
    ...
    description: 'Compress PDF files to reduce file size while maintaining quality. Free online PDF compressor for easy sharing and storage. No sign-up needed.',
    url: 'https://toolifypdf.online/compress-pdf',
    type: 'website',
    images: [{ url: 'https://toolifypdf.online/og-image.jpg', width: 1200, height: 630, alt: 'Compress PDF — Reduce PDF File Size Free | Toolify' }],
  },
  twitter: {
