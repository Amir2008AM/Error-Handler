...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Extract tables from any PDF and download them as a clean Excel spreadsheet. Works on text-based and scanned PDFs using OCR. Free, fast.',
    url: 'https://www.toolifypdf.online/pdf-to-excel',
    type: 'website',
    images: [{ url: 'https://www.toolifypdf.online/og-image.jpg', width: 1200, height: 630, alt: 'PDF to Excel — Extract Tables from PDF | Toolify' }],
  },
  twitter: {
