...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.toolifypdf.online/contact-us' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Contact Us | Toolify',
    description: 'Get in touch with the Toolify team. Send us a message for support, feedback, or partnership inquiries about our free online tools.',
    url: 'https://www.toolifypdf.online/contact-us',
    type: 'website',
    images: [{ url: 'https://www.toolifypdf.online/og-image.jpg', width: 1200, height: 630, alt: 'Contact Us | Toolify' }],
  },
  twitter: {
