...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'ToolifyPDF — Free PDF, Image & Document Tools Online',
    description: 'Free online tools for PDF, images, text, and conversions. Compress images, merge PDFs, convert files, and more — no registration needed.',
    url: 'https://toolifypdf.online',
    type: 'website',
    images: [{ url: 'https://toolifypdf.online/og-image.jpg', width: 1200, height: 630, alt: 'ToolifyPDF — Free PDF, Image & Document Tools Online' }],
  },
  twitter: {
