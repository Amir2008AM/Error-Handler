      ...
      <section className="bg-white border-b border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16 text-center">
          <h1
            ...
            className="wave-heading inline-block select-none text-3xl md:text-4xl lg:text-5xl font-bold leading-normal mb-4 pb-1 text-balance bg-clip-text text-transparent"
            style={{
